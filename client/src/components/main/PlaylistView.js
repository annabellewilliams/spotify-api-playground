...
const ID = "3iTKGag2YpqUWiNuCXQ6Wv";

const PlaylistView = () => {
    return <TrackList id={ID} container="playlists" />;
}
...
// const ID = "3iTKGag2YpqUWiNuCXQ6Wv";
//
// const PlaylistView = ({ tracks, fetchTracks }) => {
//     // fetchTracks('playlists', props.id)
//     useEffect(() => {
//         fetchTracks('playlists', ID);
//     }, [fetchTracks]);
//
