...
export const ARTIST_SELECTED_REQUESTED = 'artist_selected_requested';
export const ARTIST_SELECTED_SUCCEEDED = 'artist_selected_succeeded';
export const ARTIST_SELECTED_FAILED = 'artist_selected_failed';

export const PLAYLIST_SELECTED_REQUESTED = 'playlist_selected_requested';
export const PLAYLIST_SELECTED_SUCCEEDED = 'playlist_selected_succeeded';
export const PLAYLIST_SELECTED_FAILED = 'playlist_selected_failed';

export const TRACK_SELECTED_REQUESTED = 'track_requested_requested';
export const TRACK_SELECTED_SUCCEEDED = 'track_requested_succeeded';
export const TRACK_SELECTED_FAILED = 'track_requested_failed';
